...
$movies = [
    $harry_potter_1 = new Movie('Harry Potter', 'Daniel Radcliffe', $harry_plot1, 'romanzo', false, 'https://www.warnerbros.it/sites/default/files/HP1_MOVIE_V_DD_KA_TT_1400x2100_300dpi_IT.jpg'),
    $harry_potter_2 = new Movie('Harry Potter 2', 'Daniel Radcliffe', $harry_plot2, 'romanzo', false, 'https://picfiles.alphacoders.com/232/thumb-232115.jpg'),
    $batman = new Movie('Batman begins', 'Christian Bale', $batman_plot, 'azione', true, 'https://m.media-amazon.com/images/I/51BZHCbJ-QL._SY445_.jpg'),
    $spiderman = new Movie('Spiderman', 'Tobey Maguire', $spiderman_plot, 'azione', false, 'https://m.media-amazon.com/images/I/81jRVXCIGeL.jpg')
];
